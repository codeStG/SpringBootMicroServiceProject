...
CREATE TABLE ADDRESS_TBL ( address_id BIGINT NOT NULL AUTO_INCREMENT, line_one VARCHAR(50) NOT NULL, line_two VARCHAR(25), city VARCHAR(21) NOT NULL, state VARCHAR(13) NOT NULL, zip VARCHAR(9) NOT NULL, PRIMARY KEY (address_id));
