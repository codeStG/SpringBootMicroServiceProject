...
public class SortByLastNameTests {
    ...
    public void setUp() {
        ...
        people = new ArrayList<>(Arrays.asList(personTwo, personOne, personThree));
    }

    @Test
    public void testPeopleSortedByLastNameAscending() {
        List<Person> sortedPeople = new ArrayList<>(Arrays.asList(personOne, personThree, personTwo));

        people.sort(new SortByLastName());
